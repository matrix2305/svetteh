 ...
 */
class Content extends \AppCore\Entities\Content implements \Doctrine\ORM\Proxy\Proxy
{
    /**
  ...
  'phone' => NULL,
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppCore\\Entities\\Content' . "\0" . 'id', '' . "\0" . 'AppCore\\Entities\\Content' . "\0" . 'name', '' . "\0" . 'AppCore\\Entities\\Content' . "\0" . 'text', '' . "\0" . 'AppCore\\Entities\\Content' . "\0" . 'adress', '' . "\0" . 'AppCore\\Entities\\Content' . "\0" . 'email', 'phone', '' . "\0" . 'AppCore\\Entities\\Content' . "\0" . 'instagram', '' . "\0" . 'AppCore\\Entities\\Content' . "\0" . 'facebook'];
        }

        return ['__isInitialized__', '' . "\0" . 'AppCore\\Entities\\Content' . "\0" . 'id', '' . "\0" . 'AppCore\\Entities\\Content' . "\0" . 'name', '' . "\0" . 'AppCore\\Entities\\Content' . "\0" . 'text', '' . "\0" . 'AppCore\\Entities\\Content' . "\0" . 'adress', '' . "\0" . 'AppCore\\Entities\\Content' . "\0" . 'email', '' . "\0" . 'AppCore\\Entities\\Content' . "\0" . 'instagram', '' . "\0" . 'AppCore\\Entities\\Content' . "\0" . 'facebook'];
    }
    ...
    public function setAdresss(string $adress): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAdresss', [$adress]);

        parent::setAdresss($adress);
    }
